...
Shader::Shader(const char* vertexPath, const char* fragmentPath, const char* geometryPath) {
    ...
    // vertex shader
    vertex = __glewCreateShader(GL_VERTEX_SHADER);
...
void Shader::checkCompileErrors(GLuint shader, const char* type) {
    ...
    if(type != "PROGRAM") {
        ...
        if(!success) {
            ...
            Logger::log( std::string("ERROR::SHADER_COMPILATION_ERROR of type: ") + type + "\n" + infoLog);
        }
    }
    else {
        ...
        if(!success) {
            ...
            Logger::log(std::string("ERROR::PROGRAM_LINKING_ERROR of type: ") +  type + "\n" + infoLog);
        }
    }
}
